...
![图 7：个人知识在对话中的引用](./images/11.png)

*图 7：知识库引用。系统基于已沉淀的业务口径回答问题，并在口径缺失时引导用户补充定义。*
...
![图 8：统一数据接入入口](./images/9.png)

*图 8：数据接入入口。用户可选择上传文件、连接数据库、在线表格或业务接口。*
...
![图 9：分析工具选择面板](./images/8.png)

*图 9：分析工具。显式工具选择与自然语言自动路由并行，满足探索与明确方法两类使用方式。*
...
![图 10：历史分析与对话结果复用](./images/5.png)

*图 10：历史分析。用户可在保存的会话中继续查看并复用已有结果。*

![图 11：个人偏好与个性化设置](./images/12.png)

*图 11：个人偏好。用户可维护稳定的输出偏好，使后续会话保持一致。*
